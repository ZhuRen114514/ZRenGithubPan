...
local lscf={}
lscf[1]={address=nydz[1].address-0x4C,flags=16,value=0}
lscf[2]={address=nydz[1].address-0x44,flags=16,value=0}
lscf[3]={address=nydz[1].address-0x3C,flags=16,value=0}
